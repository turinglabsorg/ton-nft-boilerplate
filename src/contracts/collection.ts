...
export class NftCollection {
    ...
    private collectionAddress: Address | undefined;

    constructor(collectionData: collectionData, collectionAddress?: String) {
        this.collectionData = collectionData;
        if (collectionAddress) {
            this.collectionAddress = collectionAddress as unknown as Address;
        }
    }
